# La Buvette de Bel'Air : construire un backend pour la célèbre buvette du festival eXalt. Avec TypeScript/Node.js, IA, et amour.
...
Vous allez construire le meilleur backend possible en utilisant TypeScript et Node.js.

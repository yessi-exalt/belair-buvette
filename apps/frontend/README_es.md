# La Buvette de Bel'Air : construyendo una aplicación web para la famosa buvette del festival eXalt. Con TypeScript/React, IA y amor.
...
Este proyecto es tu terreno de juego para crear una aplicación web y un design system para la experiencia de bebidas y snacks del festival.

Vas a construir el mejor frontend posible usando TypeScript y React.
...
belair-buvette/
 apps/
  frontend/
   packages/
    domain/           # Lógica de negocio, entidades e interfaces de dominio
    application/      # Casos de uso y servicios de aplicación
    infrastructure/   # Clientes de API, adaptadores e integraciones externas
    ui/               # Design system  componentes React, tokens de diseño, Storybook
```

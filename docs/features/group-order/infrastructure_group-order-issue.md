...
1. Scenario: Charger les informations d'une commande groupée par code
    ...
    Then il retourne le résumé mappé avec le total groupé et le coût restant

2. Scenario: Envoyer la contribution à l'API
    ...
    And le corps de la requête contient les montants contributés
